...
public:
    METHOD_LIST_BEGIN
        ADD_METHOD_TO(MissionsController::list,    "/api/v1/missions",            drogon::Get);
        ADD_METHOD_TO(MissionsController::create,  "/api/v1/missions",            drogon::Post);
        ADD_METHOD_TO(MissionsController::getOne,  "/api/v1/missions/{1}",        drogon::Get);
        ADD_METHOD_TO(MissionsController::lock,    "/api/v1/missions/{1}/lock",   drogon::Post);
    METHOD_LIST_END
